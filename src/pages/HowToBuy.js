        ...
        <PageContent>
            <Section height={"100vh"}>
                <Div width={"80%"} flexDirection={"column"}>
                    <MainHeading style={{paddingTop: "23vh", opacity: "0"}} animate={{translateY: [100,0],skewY: [20,0], opacity:[0,1]}} transition={{delay:1.5, duration:1.5, type: "spring"}} >How to buy Bukele</MainHeading>
                    ...
                    <Div height={"40%"}>
                        <Button animate={{opacity: [0,1], translateY: [-100,0]}} transition={{delay:3.5, ...FastTransition}} style={{opacity:"0"}}> GO TO PANCAKESWAP</Button>
                    </Div>
                </Div>
            </Section>
